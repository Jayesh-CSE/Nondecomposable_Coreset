...
for i in range(1,8):
    ...
    for r in R:
	    ...
	    p1 = F1_score_hyperparam.F1_score(x_train, y_train, x_train, y_train, r)

	    weight_final, candidate_set, inter_F1 = p1.Main()

	    print("f1 score : {}".format(p1.Predict(weight_final)))

	    print("Test samples label distribution: {}".format(np.unique(y_train, return_counts=True)))
    ...
    sum_f1 = sum_f1 + max_f1

    f1_score_fulldata.append(max_f1)

print("Average f1 score : {}".format(sum_f1/7))
